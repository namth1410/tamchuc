...
function MuCangChaiTrip() {
  ...
  useEffect(() => {
    document.documentElement.style.setProperty('--trip-primary', '#2d4f1e');
    document.documentElement.style.setProperty('--trip-bg', '#050a06');
  }, []);
    ...
    <div className="min-h-screen bg-[var(--bg-dark)] text-white selection:bg-[var(--accent)]/40 selection:text-black transition-colors duration-1000">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 md:px-8 py-4 md:py-6 pointer-events-none">
        <div className="container flex justify-between items-center pointer-events-auto">
          ...
          >
            <Link to="/" className="inline-flex items-center gap-2 text-white/50 hover:text-white transition-colors font-semibold text-xs py-1">
            ...
            >
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-[var(--accent)] flex-center text-black text-xl md:text-2xl font-black shadow-lg shadow-[var(--accent)]/40 group-hover:scale-110 transition-transform">
                M
              </div>
              <div className="flex flex-col">
                ...
                <span className="text-[var(--accent)] text-[10px] md:text-xs font-bold tracking-[0.3em]">
                  HÀNH TRÌNH 2026
                </span>
              </div>
            </div>
          ...
          >
            <button 
              onClick={handleShare}
              className="glass px-4 md:px-8 py-2.5 md:py-3 rounded-2xl flex items-center gap-2 md:gap-3 hover:bg-[var(--accent)] hover:text-black transition-all font-black text-[10px] md:text-sm group"
            >
              <Share2
                size={16}
                className="group-hover:rotate-12 transition-transform text-[var(--accent)] group-hover:text-black"
              />
        ...
        <div className="container relative z-10">
          <div className="max-w-5xl">
            <motion.span
              ...
              className="inline-flex items-center gap-3 px-4 md:px-6 py-2 md:py-2.5 rounded-full border border-[var(--accent)]/60 bg-[var(--accent)]/20 text-[var(--accent)] text-[10px] md:text-sm font-black uppercase tracking-[0.2em] mb-6 md:mb-10 shadow-[0_0_20px_rgba(255,204,0,0.1)]"
            >
              <div className="w-2 md:w-2.5 h-2 md:h-2.5 rounded-full bg-[var(--accent)] animate-pulse" />
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-8">
            ...
            <div className="glass px-4 md:px-6 py-3 md:py-4 flex gap-6 md:gap-8 w-full md:w-auto overflow-x-auto whitespace-nowrap">
              ...
              <div className="flex items-center gap-2 md:gap-3">
                <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-[var(--accent)]" />
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 md:mb-20 gap-8 md:gap-10">
            <div>
              ...
              <p className="text-lg md:text-xl text-white/70 font-medium">
                Hãy chọn tối đa{" "}
                <span className="text-[var(--accent)] font-black">3 phương án</span> để
            ...
            <div className="flex bg-white/5 p-1.5 md:p-2 rounded-2xl border border-white/10 backdrop-blur-md w-full sm:w-auto">
              ...
              >
                ...
                {selectedPlans.length > 0 && (
                  <span
                    className={`ml-1 w-5 h-5 md:w-6 md:h-6 rounded-full flex-center text-[10px] md:text-xs ${isCompareMode ? "bg-black text-white" : "bg-[var(--accent)] text-black"}`}
                  >
                ...
                >
                  ...
                  <div className="contents">
                    <div className="p-8 flex items-center border-r border-b border-white/10 bg-white/5">
                      <span className="text-[var(--accent)] font-black tracking-widest text-sm italic">
                        MA TRẬN SO SÁNH
                      </span>
                    </div>
                    {plans
                          ...
                          <div className="space-y-4">
                            {plan.points.map((step, idx) => (
                              <div key={idx} className="flex gap-4 items-start">
                                <div className="w-6 h-6 rounded-lg bg-[var(--accent)]/20 flex-center flex-shrink-0 text-[10px] font-black border border-[var(--accent)]/20 text-[var(--accent)]">
                                  {idx + 1}
                                </div>
      ...
      {/* Trip Dock Handle */}
      <TripDock tripId="mu-cang-chai" />

      {/* Footer */}
      <footer className="py-24 border-t border-white/5 bg-black/20">
        <div className="container text-center">
          <div className="mb-12 flex-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-[var(--accent)] flex-center text-black font-black text-2xl shadow-2xl shadow-accent/20">
              M
            </div>
            <div className="text-left">
              ...
              <div className="text-[var(--accent)] text-[10px] font-bold tracking-[0.4em]">
                HÀNH TRÌNH 2026
              </div>
            </div>
          </div>
