    ...
    <div className="min-h-screen bg-[#0a0f0b] text-white selection:bg-accent/40 selection:text-black">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-8 py-6 pointer-events-none">
        <div className="container flex justify-between items-center pointer-events-auto">
          ...
          >
            <div className="w-12 h-12 rounded-2xl bg-[#ffcc00] flex-center text-black text-2xl font-black shadow-lg shadow-accent/40 group-hover:scale-110 transition-transform">
              M
            </div>
            <div className="flex flex-col">
              ...
              <span className="text-accent text-xs font-bold tracking-[0.3em]">
                HÀNH TRÌNH 2026
              </span>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
          >
            <button className="glass px-8 py-3 rounded-2xl flex items-center gap-3 hover:bg-white/20 transition-all font-black text-sm group">
              <Share2
                size={18}
      ...
      {/* Hero Section */}
      <header className="relative pt-60 pb-32 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[900px] bg-gradient-to-b from-moss-green/40 to-transparent blur-[140px] pointer-events-none" />
        ...
        <div className="container relative z-10">
          <div className="max-w-5xl">
            <motion.span
              ...
              className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full border border-accent/60 bg-accent/20 text-accent text-sm font-black uppercase tracking-[0.2em] mb-10 shadow-[0_0_20px_rgba(255,204,0,0.1)]"
            >
            ...
            <motion.h1
              ...
              className="text-6xl md:text-[10rem] font-black mb-12 leading-[1.1] tracking-tight pb-4"
            >
              MÙ CANG CHẢI <br />
            ...
            <motion.p
              ...
              className="text-2xl text-white/90 max-w-3xl mb-16 leading-relaxed font-semibold drop-shadow-lg"
            >
            ...
            >
              <button
                ...
                className="bg-accent text-black font-black py-7 px-14 rounded-3xl hover:bg-accent-hover hover:translate-y-[-4px] active:translate-y-0 transition-all flex items-center gap-4 shadow-[0_25px_60px_rgba(255,204,0,0.4)] text-xl uppercase tracking-wider"
              >
      ...
      <section className="py-24 bg-white/[0.02]">
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            ...
            <div className="glass px-6 py-4 flex gap-8">
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 rounded-full bg-sky-blue" />
                <span className="font-bold">Mùa Nước Đổ</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 rounded-full bg-accent" />
                <span className="font-bold">Mùa Lúa Chín</span>
              </div>
            </div>
          </div>
      ...
      <section id="plans" className="py-32 relative">
        <div className="container">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-20 gap-10">
            <div>
              <h2 className="text-6xl font-black mb-6">Hành trình Đề xuất</h2>
              <p className="text-xl text-white/70 font-medium">
                Hãy chọn tối đa{" "}
            ...
            <div className="flex bg-white/5 p-2 rounded-2xl border border-white/10 backdrop-blur-md">
              <button
                ...
                className={`flex items-center gap-3 px-8 py-3.5 rounded-xl transition-all font-bold ${!isCompareMode ? "bg-white text-black shadow-xl" : "text-white/60 hover:text-white"}`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-3 px-8 py-3.5 rounded-xl transition-all font-bold ${isCompareMode ? "bg-white text-black shadow-xl" : "text-white/60 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed"}`}
              >
                <Columns2 size={20} /> So sánh
                {selectedPlans.length > 0 && (
                  <span
                    className={`ml-1 w-6 h-6 rounded-full flex-center text-xs ${isCompareMode ? "bg-black text-white" : "bg-accent text-black"}`}
                  >
          ...
          <AnimatePresence mode="wait">
            {!isCompareMode ? (
              ...
              >
                <div
                  className="min-w-[1000px] glass bg-white/5 border-white/10 overflow-hidden"
                  style={{
                    display: "grid",
                    gridTemplateColumns: `250px repeat(${selectedPlans.length}, 1fr)`,
                  }}
                >
                  {/* Header Row */}
      ...
      <AnimatePresence>
        {viewingPlanId && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex-center p-6 md:p-12 lg:p-24"
          >
            <div
            ...
            <motion.div
              ...
              className="glass w-full max-w-5xl max-h-full overflow-y-auto relative z-10 p-10 md:p-16 border-white/20 shadow-[0_0_100px_rgba(0,0,0,0.8)]"
            >
              <button
                onClick={() => setViewingPlanId(null)}
                className="absolute top-8 right-8 w-14 h-14 glass rounded-full flex-center hover:bg-white hover:text-black transition-all"
              >
                <X size={32} />
              </button>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-8 mb-10">
                    <div className="glass-dark p-6 rounded-2xl border border-white/5">
                      <div className="text-white/40 text-xs font-bold uppercase mb-2">
                        Thời lượng
                      </div>
