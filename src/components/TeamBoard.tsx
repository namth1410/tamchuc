...
const teamMembers = [
    { name: 'Hiếu', role: 'Trưởng Ban Tổ Chức', description: 'Người khởi xướng mọi cuộc vui. Lên timeline chuẩn chỉ.', avatar: 'https://api.dicebear.com/7.x/notionists/svg?seed=Hieu&backgroundColor=b6e3f4', color: 'from-blue-400 to-cyan-300' },
    { name: 'Dung', role: 'Kế Toán Kiêm Thủ Quỹ', description: 'Tay hòm chìa khóa. Thích thu tiền hơn đi chơi.', avatar: 'https://api.dicebear.com/7.x/notionists/svg?seed=Dung&backgroundColor=c0aede', color: 'from-purple-400 to-pink-300' },
    ...
    { name: 'Dũng', role: 'Thánh Phá Mồi', description: 'Đi chùa là phụ, ăn trưa là chính.', avatar: 'https://api.dicebear.com/7.x/notionists/svg?seed=Dinh&backgroundColor=d1d4f9', color: 'from-indigo-400 to-blue-300' },
    ...
    { name: 'Tâm', role: 'Nhà Bảo Hành Tâm Linh', description: 'Chăm đi lễ sớm, xin quẻ bói siêu chuẩn.', avatar: 'https://api.dicebear.com/7.x/notionists/svg?seed=Tam&backgroundColor=c0aede', color: 'from-violet-400 to-purple-300' },
    ...
    { name: 'Mai Anh', role: 'Nữ Hoàng Cuốc Bộ', description: 'Thề sẽ leo đến Đỉnh Thất Tinh đầu tiên.', avatar: 'https://api.dicebear.com/7.x/notionists/svg?seed=MaiAnh&backgroundColor=ffd5dc', color: 'from-pink-400 to-rose-300' },
];
